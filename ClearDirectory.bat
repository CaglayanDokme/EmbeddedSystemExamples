...
::  Date        : September 20, 2021 -> Created.
::		: September 21, 2021 -> ioplanning folder added to list
...
:: Delete the .ioplanning folder
if exist %baseName%.ioplanning\ (
    echo ioplanning folder deleted!
    
    rmdir /s/q %baseName%.ioplanning
)
